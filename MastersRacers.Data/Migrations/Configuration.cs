namespace MastersRacers.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RaceContext>
    {
        ...
        private void LocationSeed(RaceContext context)
        {
            ...
            Location l1 = new Models.Location { ID = l1Id, Name = "Springhill Winter Park", Description = "The usual home base of the Manitoba Master's Racing club.", LatPos = 49.96129, LongPos = -96.9814337 };
        ...
        private void RacerSeed(RaceContext context)
        {
            ...
            Racer r2 = new Models.Racer { ID = r3Id, BibNumber = 3, Name = "Three Test", RaceSeries = "Bronze Men" };
            ...
            Racer r4 = new Models.Racer { ID = r5Id, BibNumber = 66, Name = "Joe Blow", RaceSeries = "Silver Men" };
            ...
            Racer r6 = new Models.Racer { ID = r7Id, BibNumber = 154, Name = "Hugh McGregor", RaceSeries = "Gold Men" };
            ...
            Racer r8 = new Models.Racer { ID = r9Id, BibNumber = 53, Name = "Speed Racer", RaceSeries = "Bronze Men" };
            ...
            Racer r10 = new Models.Racer { ID = r11Id, BibNumber = 33, Name = "Slalom Racer", RaceSeries = "Platinum Men" };
            ...
            Racer r12 = new Models.Racer { ID = r13Id, BibNumber = 73, Name = "Flo Hills", RaceSeries = "Bronze Women" };
